...
slug: holding-a-view
type: pattern
summary: Having a position before all the evidence is in, and holding it openly while
  remaining genuinely revisable. The antidote to analysis paralysis.
collection: commons-engineer
aliases_list:
- Provisional Stance
- Revisable Conviction
