...
type: pattern
summary: A pattern for maintaining two complementary representations of the same system
  — a structured graph for machines and a curated narrative for humans — with defined
